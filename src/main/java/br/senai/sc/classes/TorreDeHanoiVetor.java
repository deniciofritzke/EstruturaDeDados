 ...
 * @author Denicio
 */
public class TorreDeHanoiVetor {
     ...
     *
     */
    public TorreDeHanoiVetor() {
        this.TAMANHO = 5;
        fimDeJogo = true;
        torres = new TorreVetor[3];
        torres[0] = new TorreVetor();
        torres[1] = new TorreVetor();
        torres[2] = new TorreVetor();
    }
    ...
    private void imprimeTorres() throws Exception {
        ...
        torresC[0] = new TorreVetor();
        torresC[1] = new TorreVetor();
        torresC[2] = new TorreVetor();
